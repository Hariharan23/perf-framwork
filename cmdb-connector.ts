...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  try {
    switch (operation) {
      ...
      default:
        return err(400, `Unknown operation: "${operation}". Valid operations: cmdb-test-connection, cmdb-search, cmdb-get-fields, cmdb-link, cmdb-refresh, cmdb-update-fields, cmdb-unlink, cmdb-get-status, cmdb-set-mapping, cmdb-get-mapping`);
    }
