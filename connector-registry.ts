...
import { PaymentCentralConnector } from './connectors/payment-central-connector';
import { GuidewireConnector } from './connectors/guidewire-connector';
...
register(new PaymentCentralConnector());
register(new GuidewireConnector());
  ...
  for (const connector of REGISTRY.values()) {
    ...
    await ddb.send(new PutItemCommand({
      ...
      Item: marshall({
        ...
        priority: connector.schema.priority ?? 100,
