...
export class CmdbConnectorStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: CmdbConnectorStackProps) {
    ...
    new ssm.StringParameter(this, 'CmdbRefreshEnabled', {
    ...
    new ssm.StringParameter(this, 'CmdbRefreshSchedule', {
    ...
    new ssm.StringParameter(this, 'CmdbRefreshLastRun', {
    ...
    this.syncRunsTable = new dynamodb.Table(this, 'CmdbSyncRunsTable', {
    ...
    const refreshSchedulerRole = new iam.Role(this, 'CmdbRefreshSchedulerRole', {
      roleName:  `${PREFIX}-cmdb-refresh-scheduler-role`,
      assumedBy: new iam.ServicePrincipal('scheduler.amazonaws.com'),
    });

    // ── Lambda: cmdb-refresh-pipeline ─────────────────────────────────────
    const refreshLambda = new lambda.Function(this, 'CmdbRefreshPipelineLambda', {
      ...
      logGroup: new logs.LogGroup(this, 'CmdbRefreshPipelineLogGroup', {
    ...
    new scheduler.CfnSchedule(this, 'CmdbRefreshSchedule', {
