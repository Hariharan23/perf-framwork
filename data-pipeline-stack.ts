...
export class DataPipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: DataPipelineStackProps) {
    ...
    const lambdaIntegration = new apigateway.LambdaIntegration(configLambda);
    pipelineResource.addMethod('GET', lambdaIntegration, {
      apiKeyRequired: true,
    });
    pipelineResource.addMethod('POST', lambdaIntegration, {
      apiKeyRequired: true,
    });
    ...
    new cdk.CfnOutput(this, 'PipelineApiUrl', {
      ...
      description: 'Endpoint for the EMS Data Pipeline API (GET, POST)',
    });
